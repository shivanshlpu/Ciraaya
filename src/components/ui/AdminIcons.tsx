...
export function ProductsIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CategoriesIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CouponsIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HomepageIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function RevenueIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
