          ...
          <div className="lg:col-span-6 space-y-6">
            <div>
              ...
              <div className="flex items-center gap-2 text-xs">
                <span className="text-[#C5A059] font-bold">★ {product.rating.toFixed(1)}</span>
            ...
            <div className="grid grid-cols-2 gap-3 py-2">
              <div className="p-3 bg-white rounded-xl border border-[#EBE6DF] text-xs space-y-1">
                <span className="font-bold text-[#18181B] block">💧 100% Waterproof</span>
                <p className="text-[11px] text-[#71717A]">Wear in shower, gym &amp; pool</p>
              </div>
              <div className="p-3 bg-white rounded-xl border border-[#EBE6DF] text-xs space-y-1">
                <span className="font-bold text-[#18181B] block">🛡️ Anti-Tarnish Coating</span>
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                ...
                className="w-full py-3 px-4 bg-[#C5A059] hover:bg-[#9E7B32] text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-colors cursor-pointer shadow-sm"
              >
        ...
        <div className="container-main">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-4 border-b border-[#EBE6DF]">
            ...
            <button
              ...
              className="ciraaya-btn ciraaya-btn-primary text-xs py-2 px-4 rounded-xl"
            >
              ★ Write a Review
            </button>
          </div>
            ...
            {reviewsList.map((rev) => (
              <div key={rev.id} className="p-5 rounded-2xl border border-[#EBE6DF] bg-[#FAFAF8] space-y-2.5">
                <div className="flex items-center justify-between">
                  <span className="text-[#C5A059] text-xs">{'★'.repeat(rev.rating)}</span>
                ...
                <div className="flex items-center gap-1.5 pt-2 border-t border-[#EBE6DF]">
                  ...
                  {rev.verified && (
                    <span className="text-[9px] font-bold text-[#2A7A4C] bg-[#EFF8F2] px-1.5 py-0.2 rounded">
                      ✓ Verified Buyer
                    </span>
                  )}
                </div>
